...
def contact():
       ...
       email_request = requests.post(request_url, auth=('api',key),data={
           ...
           'to': email,
           'subject': subject,
           'html':'<html><p style="color:beige;font-size:40px; background-color:coral;">Warm welcome!<br> We will answer all of your questions! <br>Meanwhile, have a look at our <a href="https://intense-refuge-72114.herokuapp.com/team">TEAM!</a></p></html>'
       })
